...
using Tyuiu.TikhomirovaKA.Sprint0.Task7.V0.Lib;

namespace Tyuiu.TikhomirovaKA.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнила Тихомирова К. А. | ИБКСб-25-1";
